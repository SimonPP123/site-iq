    ...
    dimensions: [
      {
        ...
        checks: [
          ...
          { id: "S12", label: "Open Graph tags", ratio: 0, evidence: { where: "Across all 8 crawled pages", checked: 8, failing: ["/", "/menu", "/about", "/locations", "/wholesale", "/blog/cold-brew-guide", "/contact", "/careers"] } },
      ...
      },
      {
        ...
        checks: [
          ...
          { id: "G6", label: "Concrete stats and figures", ratio: 0.5, evidence: { where: "Across all 8 crawled pages", checked: 8, failing: ["/", "/menu", "/locations", "/contact"] } },
          { id: "G15", label: "Authoritative citations", ratio: 0, evidence: { where: "Across all 8 crawled pages", checked: 8, failing: ["/", "/menu", "/about", "/locations", "/wholesale", "/blog/cold-brew-guide", "/contact", "/careers"] } },
